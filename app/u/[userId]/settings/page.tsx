...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-dvh" style={{ backgroundColor: '#F8F4EF' }}>
      ...
      >
        <h1 className="text-xl font-black tracking-tight" style={{ color: '#1C1C1E' }}>設定</h1>
      </header>

      <main className="px-5 pb-28 flex flex-col gap-4">
        <div className="bg-white rounded-2xl px-5 py-4 shadow-sm">
          <h2 className="text-xs font-semibold uppercase tracking-wide mb-4" style={{ color: '#8E8E93' }}>費用設定</h2>
          <div className="flex flex-col gap-4">
            <div>
              <label className="text-sm font-medium" style={{ color: '#1C1C1E' }}>月会費</label>
            ...
            <div>
              <label className="text-sm font-medium" style={{ color: '#1C1C1E' }}>1回あたり交通費</label>
              <div className="flex items-center gap-2 mt-1.5">
                <span className="text-sm font-medium" style={{ color: '#8E8E93' }}>¥</span>
                <input
                  type="number"
        ...
        <div className="bg-white rounded-2xl px-5 py-4 shadow-sm">
          <h2 className="text-xs font-semibold uppercase tracking-wide mb-4" style={{ color: '#8E8E93' }}>月間目標</h2>
          <div className="flex flex-col gap-4">
            <div>
              <label className="text-sm font-medium" style={{ color: '#1C1C1E' }}>目標通い回数</label>
              <div className="flex items-center gap-4 mt-2">
                ...
                >−</button>
                <span className="flex-1 text-center text-3xl font-black" style={{ color: '#1C1C1E' }}>{settings.targetSessions}</span>
            ...
            <div>
              <label className="text-sm font-medium" style={{ color: '#1C1C1E' }}>目標ラウンド数</label>
              <div className="flex items-center gap-4 mt-2">
                <button
                  ...
                  style={{ backgroundColor: '#F8F4EF', color: '#1C1C1E' }}
                >−</button>
                <span className="flex-1 text-center text-3xl font-black" style={{ color: '#1C1C1E' }}>{settings.targetRounds}</span>
        ...
        <div className="bg-white rounded-2xl px-5 py-4 shadow-sm">
          <h2 className="text-xs font-semibold uppercase tracking-wide mb-3" style={{ color: '#8E8E93' }}>アプリについて</h2>
          <div className="flex flex-col gap-2">
            <div className="flex justify-between text-sm">
              <span style={{ color: '#8E8E93' }}>ユーザーID</span>
              <span className="font-bold" style={{ color: '#FF6B35' }}>{userId}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span style={{ color: '#8E8E93' }}>データ保存先</span>
              <span style={{ color: '#1C1C1E' }}>クラウド (Supabase)</span>
            </div>
          </div>
        </div>
